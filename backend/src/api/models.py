...
from sqlalchemy import Column, Integer, String, Boolean, DateTime, ForeignKey, Float, Text, func, text, true, false
...
class Pin(Base):
    ...
    likes_count = Column(Integer, server_default=text("0"), nullable=False)
